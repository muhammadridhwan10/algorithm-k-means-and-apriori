...
function reset_temporary($db_object){
    $sql1 = "TRUNCATE tbl_itemset1";
    $db_object->db_query($sql1);
    
    $sql2 = "TRUNCATE tbl_itemset2";
    $db_object->db_query($sql2);
    
    $sql3 = "TRUNCATE tbl_itemset3";
    $db_object->db_query($sql3);
    
    $sql4 = "TRUNCATE tbl_confidence";
    $db_object->db_query($sql4);
}

function reset_hitungan($db_object, $id_process){
    $condition = array("id_process"=>$id_process);
    $db_object->delete_record("tbl_itemset1", $condition);
    
    //$condition = array("id_process"=>$id_process);
    $db_object->delete_record("tbl_itemset2", $condition);
    
    //$condition = array("id_process"=>$id_process);
    $db_object->delete_record("tbl_itemset3", $condition);
    
    //$condition = array("id_process"=>$id_process);
    $db_object->delete_record("tbl_confidence", $condition);
}
...
function mining_process($db_object, $min_support, $min_confidence, $start_date, $end_date, $id_process){
    ...
    $sql_trans = "SELECT * FROM tbl_transaksi 
    ...
    $sql_insert_itemset1 = "INSERT INTO tbl_itemset1 (atribut, jumlah, support, lolos, id_process) "
            . " VALUES ".$value_insert;
    ...
    $sql_insert_itemset2 = "INSERT INTO tbl_itemset2 (atribut1, atribut2, jumlah, support, lolos, id_process) "
    ...
    $sql_insert_itemset3 = "INSERT INTO tbl_itemset3(atribut1, atribut2, atribut3, jumlah, support, lolos, id_process) "
    ...
    $sql_3 = "SELECT * FROM tbl_itemset3 WHERE lolos = 1 AND id_process = ".$id_process;
    ...
    //dari itemset 2
    $sql_2 = "SELECT * FROM tbl_itemset2 WHERE lolos = 1 AND id_process = ".$id_process;
...
function get_count_itemset3($db_object, $atribut1, $atribut2, $atribut3, $start_date, $end_date) {
    $sql = "SELECT COUNT(transaction_date) AS jml, transaction_date FROM tbl_transaksi 
...
//    while($row1_ = $db_object->db_fetch_array($res1_)){
    ...
    $nilai_support_x = ($jml_itemset2/$jumlah_transaksi) * 100;
        ...
        $db_object->insert_record("tbl_confidence", 
